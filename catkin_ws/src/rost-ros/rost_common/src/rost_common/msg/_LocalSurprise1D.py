"""autogenerated by genpy from rost_common/LocalSurprise1D.msg. Do not edit."""
import sys
...
class LocalSurprise1D(genpy.Message):
  _md5sum = "b3d04bb22caeb50cfaed5d24887be29e"
  _type = "rost_common/LocalSurprise1D"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint32 seq
float32[] surprise

"""
  __slots__ = ['seq','surprise']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalSurprise1D, self).__init__(*args, **kwds)
